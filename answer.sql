...
SELECT * FROM players WHERE team = 'IND' AND players.age < 26;
...
-- The team and total points scored from all players on that
...
SELECT players.team, COUNT(name) FROM players WHERE points/games > 12 GROUP BY players.team ORDER BY COUNT (name);